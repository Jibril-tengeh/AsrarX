import{aG as R,aH as _,aI as C,aJ as x,aK as ue,aL as j,aM as Ue,aN as g,aO as Ve,aP as Ge,aQ as We,aR as Je,aS as E}from"./index-DrAQDrbk.js";const de="@firebase/installations",L="0.6.22";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Hn(e=Ve()){return Nn().then(t=>{if(!t)throw c.create("unsupported-browser")},t=>{throw c.create("indexed-db-unsupported")}),x(g(e),"messaging").getImmediate()}async function xn(e,t){return e=g(e),qe(e,t)}function jn(e){return e=g(e),On(e)}function Ln(e,t){return e=g(e),Mn(e,t)}async function qn(e,t){return e=g(e),J(e,t)}async function Bn(e){return e=g(e),Kn(e)}function Un(e,t){return e=g(e),Fn(e,t)}function Vn(e,t){return e=g(e),Pn(e,t)}Dn();export{jn as deleteToken,Hn as getMessaging,xn as getToken,Nn as isSupported,Ln as onMessage,Un as onRegistered,Vn as onUnregistered,qn as register,Bn as unregister};
