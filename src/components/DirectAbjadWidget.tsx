              ...
              {isExpanded && (
                ...
                >
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    {lettersBreakdown.map((item, itmIdx) => (
                      <div
                        key={item.id ? `lt-brk-${item.id}-${itmIdx}` : `lt-brk-${itmIdx}`}
