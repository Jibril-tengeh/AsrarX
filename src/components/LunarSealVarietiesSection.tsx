...
export const LunarSealVarietiesSection: React.FC<LunarSealVarietiesSectionProps> = ({
  ...
  return (
    <div className="w-full bg-black/80 border border-purple-500/30 rounded-3xl p-4 sm:p-6 shadow-2xl text-left space-y-6 select-none">
      {/* Section Header */}
      ...
      <AnimatePresence>
        {isAdmin && showAdminPanel && (
          <motion.div
            ...
            className="overflow-hidden bg-purple-950/40 border border-amber-500/40 rounded-2xl p-4 sm:p-5 space-y-4"
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-2 max-h-72 overflow-y-auto pr-1">
              {LUNAR_SEAL_VARIETIES.map((seal) => {
                ...
                return (
                  <div
                    key={seal.id}
                    className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 bg-black/70 border border-purple-500/20 p-2.5 rounded-xl"
                  >
                    ...
                    <div className="flex items-center gap-1.5 flex-shrink-0">
                      ...
                      <select
                        ...
                        className="bg-purple-950/90 text-amber-200 text-[10px] font-bold py-1 px-1.5 rounded-lg border border-purple-500/40 cursor-pointer"
                      >
                      ...
                      <select
                        ...
                        className="bg-black/90 text-gray-300 text-[10px] font-bold py-1 px-1.5 rounded-lg border border-gray-700 cursor-pointer"
                      >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
              ...
              <div className="lg:col-span-5 space-y-3">
                ...
                <div className="grid grid-cols-2 gap-2">
                  ...
                  <button
                    ...
                    className="flex items-center justify-center gap-1.5 bg-purple-950/60 hover:bg-purple-900/80 border border-purple-500/30 text-purple-200 font-bold py-2.5 px-3 rounded-xl transition-colors cursor-pointer"
                  >
                    {copiedSymbol ? (
                      <>
              ...
              <div className="lg:col-span-7 space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div className="bg-black/60 border border-purple-500/30 rounded-2xl p-3.5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 text-xs">
                  <div className="bg-purple-950/30 border border-purple-500/20 rounded-xl p-2.5">
        ...
        {isFullScreen && activeSeal && (
          <div className="fixed inset-0 z-50 bg-black/95 backdrop-blur-xl flex items-center justify-center p-4 overflow-y-auto">
            <motion.div
              ...
              className="bg-black/90 border-2 border-amber-500/50 rounded-3xl p-6 max-w-3xl w-full text-center space-y-6 shadow-2xl relative"
            >
              <button
                type="button"
                onClick={() => setIsFullScreen(false)}
                className="absolute top-4 right-4 text-gray-400 hover:text-white p-2 rounded-full bg-purple-950/60 border border-purple-500/30 cursor-pointer"
              >
                ✕
              </button>
