...
export const MuraqabahLogModal: React.FC<MuraqabahLogModalProps> = ({
  ...
  return (
    <AnimatePresence>
      ...
      >
        <div className="relative w-full max-w-2xl max-h-[90vh] bg-white dark:bg-[#0c0a14] border border-amber-500/30 rounded-3xl p-5 sm:p-7 text-gray-900 dark:text-white flex flex-col justify-between overflow-hidden shadow-2xl shadow-amber-500/10 z-10">
          
          {/* Header */}
          <div className="flex justify-between items-start border-b border-amber-500/20 pb-4 mb-4">
            <div>
              <div className="flex items-center gap-2">
                <div className="w-8 h-8 rounded-xl bg-amber-500/20 flex items-center justify-center text-amber-600 dark:text-amber-400 border border-amber-500/30">
                  <BookOpen size={16} />
                </div>
                <div>
                  ...
                  <h3 className="text-lg font-serif font-bold text-amber-800 dark:text-amber-200">
