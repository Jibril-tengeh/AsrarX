...
export const NewVersionBannerModal: React.FC<NewVersionBannerModalProps> = ({
  ...
  return (
    <>
      {/* Floating Action Banner with Force Refresh and Changelog buttons */}
      <div 
      ...
      {/* Video card modal is ONLY rendered if admin explicitly enabled video card for this release */}
      {!isVideoCardDisabled && (
        <UpdateVideoCardModal
          ...
          onRefreshCache={handleForceRefresh}
        />
      )}

      {/* Changelog detailed modal when user clicks 'Nouveautés' */}
      <ChangelogModal
