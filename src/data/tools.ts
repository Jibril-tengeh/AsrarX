...
export const tools: ToolItem[] = [
  ...
  {
    id: "pdf",
    title: "Bibliothèque des Manuscrits & Livres PDF",
    description: "Consultation, lecture et téléchargement de manuscrits authentiques, grimoires et ouvrages ésotériques sacrés.",
    icon: BookOpen,
  ...
  {
    id: "calendar",
    title: "Convertisseur de Calendrier Sacré",
    description: "Correspondances dates Hijri et Grégoriennes, nuits sacrées, moments bénis et phases célestes.",
    icon: Clock,
  ...
  {
    id: "quizz",
    title: "Quizz Spirituel & Connaissances Ésotériques",
    description: "Testez vos connaissances en sciences spirituelles, Asma al-Husna, géomancie et sagesse soufie.",
    icon: Sparkles,
    color: "from-purple-600 via-pink-600 to-indigo-900",
    path: "/tools/quizz",
    level: "simple",
  },
  {
    id: "lexique",
    title: "Lexique Ésotérique & Terminologie Soufie",
    description: "Dictionnaire des termes mystiques, concepts d'Ilm al-Huruf, Rouhaniyya et sagesses des maîtres.",
    icon: BookOpen,
  ...
  {
    id: "journal",
    title: "Journal Spirituel du Salik",
    description: "Espace personnel de recueillement, notes de méditation, suivi des songes et invocations quotidiennes.",
    icon: Feather,
    color: "from-amber-600 via-yellow-600 to-stone-900",
    path: "/tools/journal",
    level: "simple",
  },
  {
    id: "cauris",
    title: "Tirage Divinatoire des Cauris",
    description: "Art divinatoire traditionnel par jet de coquillages sacrés, analyse des polarités ouvertes/fermées et présages ancestraux.",
    icon: Coins,
    color: "from-amber-500 via-yellow-600 to-orange-900",
    path: "/tools/cauris",
    level: "advanced",
  },
  {
    id: "azlam",
    title: "Tirage des Flèches Sacrées (Azlam)",
    description: "Consultation oraculaire traditionnelle par flèches de discernement spirituel pour prises de décision et orientation.",
    icon: Target,
    color: "from-rose-600 via-orange-600 to-amber-900",
    path: "/tools/azlam",
    level: "advanced",
  },
  {
    id: "ifa",
    title: "Oracle Ifa Africain (16 Odu Majeurs)",
    description: "Système géomantique ouest-africain (Yoruba), tracé et interprétation théurgique des 16 Odus fondamentaux.",
    icon: Shapes,
    color: "from-emerald-600 via-green-700 to-stone-950",
    path: "/tools/ifa",
    level: "advanced",
  },
  {
    id: "sikidy",
    title: "Géomancie Traditionnelle Sikidy",
    description: "Système divinatoire malgache hérité de la géomancie arabe, érection des 16 maisons et dynamiques de destin.",
    icon: Compass,
    color: "from-teal-600 via-cyan-700 to-slate-950",
    path: "/tools/sikidy",
    level: "advanced",
  },
  {
    id: "nakshatras",
    title: "Nakshatras Védiques & Shakti",
    description: "Les 27 demeures lunaires védiques de l'Inde ancienne, divinités associées, symboles sacrés et influx karmiques.",
    icon: Star,
    color: "from-violet-600 via-purple-700 to-indigo-950",
    path: "/tools/nakshatras",
    level: "advanced",
  },
  {
    id: "feng-shui",
    title: "Boussole Feng Shui Kua & BaGua",
    description: "Calcul du Ming Kua personnel, orientations cardinales fastes et harmonisation des trigrammes sacrés du BaGua.",
    icon: Compass,
    color: "from-red-600 via-orange-600 to-amber-950",
