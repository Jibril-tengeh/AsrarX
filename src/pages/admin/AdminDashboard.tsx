...
import { CategoryVideoOrIconBadge } from '../../components/common/CategoryDynamicIcon';
...
export const SYSTEM_FEATURES = [
  ...
  { id: 'profile', label: 'Profil Utilisateur & Paramètres', desc: 'Mon profil, compte, réglages et paramètres personnels', category: 'nav' },
...
export const AdminDashboard: React.FC = () => {
  ...
  const handleAddUsersSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (addUserMode === 'single') {
        ...
        const uniqueEmails: string[] = Array.from(new Set(rawLines));
  ...
  const handleToggleFeature = async (
    ...
    } else if (featureId === 'home_categories_icon_style') {
      extraFields['home_categories_icon_style'] = newValue;
      extraFields['home_categories_use_video_presets'] = newValue === 'video';
    }
        ...
        >
          <div className="space-y-4">
            ...
            <div className="pt-3 border-t border-gray-100 dark:border-gray-700 space-y-3">
              ...
              {/* Paramètres d'apparence & de luminosité des icônes de catégories */}
              <div className="pt-4 border-t border-gray-100 dark:border-gray-700/60 space-y-3.5">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-[11px] text-gray-500 dark:text-gray-400">
                        Réglez la clarté, éliminez l'effet noirci et choisissez le style visuel des badges
                      </p>
                    </div>
                  </div>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-2">
                  {[
                    ...
                    return (
                      <button
                        key={`cat-icon-style-${styleOpt.id}`}
                        type="button"
                        onClick={() => handleToggleFeature('home_categories_icon_style', styleOpt.id, `Style icône ${styleOpt.label}`)}
                ...
                <div className="p-3 rounded-xl bg-gray-50 dark:bg-gray-800/60 border border-gray-200 dark:border-gray-700 flex items-center justify-between gap-3">
                  ...
                  <button
                    type="button"
                    onClick={() => handleToggleFeature('home_categories_remove_dark_overlay', featureToggles?.home_categories_remove_dark_overlay === false ? true : false, "Suppression filtre sombre")}
                    className={`w-10 h-5 flex items-center rounded-full p-0.5 transition-colors cursor-pointer shrink-0 ${
                ...
                <div className="p-3 rounded-xl bg-gray-50 dark:bg-gray-800/60 border border-gray-200 dark:border-gray-700 space-y-2">
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      type="button"
                      onClick={() => handleToggleFeature('home_categories_icon_brightness', Math.max(60, (featureToggles?.home_categories_icon_brightness || 100) - 10), "Luminosité icônes")}
                    ...
                    <input
                      ...
                      onChange={(e) => handleToggleFeature('home_categories_icon_brightness', parseInt(e.target.value), "Luminosité icônes")}
                      className="flex-1 accent-emerald-500 cursor-pointer h-2 bg-gray-200 dark:bg-gray-700 rounded-lg"
                    />
                    <button
                      type="button"
                      onClick={() => handleToggleFeature('home_categories_icon_brightness', Math.min(150, (featureToggles?.home_categories_icon_brightness || 100) + 10), "Luminosité icônes")}
                      className="w-7 h-7 rounded-lg bg-gray-200 dark:bg-gray-700 hover:bg-emerald-100 flex items-center justify-center font-bold text-sm text-gray-700 dark:text-gray-200 cursor-pointer"
                    >
                      +
                    </button>
                  ...
                  <div className="flex items-center gap-1.5 pt-1 overflow-x-auto">
                    {[
                      ...
                      <button
                        key={`bright-preset-${preset.val}`}
                        type="button"
                        onClick={() => handleToggleFeature('home_categories_icon_brightness', preset.val, `Luminosité ${preset.label}`)}
                ...
                <div className="flex items-center justify-between p-3 rounded-xl bg-gray-50 dark:bg-gray-800/60 border border-gray-200 dark:border-gray-700">
                  ...
                  <div className="flex items-center gap-1.5">
                    {[
                      ...
                      <button
                        key={`cat-icon-col-${colOpt.id}`}
                        type="button"
                        onClick={() => handleToggleFeature('home_categories_icon_color_mode', colOpt.id, `Couleur icône ${colOpt.label}`)}
