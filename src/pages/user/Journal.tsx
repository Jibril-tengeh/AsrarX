...
export const Journal: React.FC = () => {
  ...
  return (
    <div 
      style={{
        paddingTop: `max(0px, calc(16px + var(--feed-journal-offset, 0px) + var(--feed-global-offset, 0px)))`
      }}
      className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 pb-24 safe-area-pt min-h-screen relative transition-all duration-300"
    >
      <div className="mb-8">
