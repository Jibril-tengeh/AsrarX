            ...
            {SHAMS_CHAPTERS.map((chap, idx) => {
              ...
              return (
                ...
                >
                  ...
                  <Icon size={14} className="relative z-10 text-amber-300" />
                    ...
                    >
                      ...
                      <div className="flex items-center justify-between sm:justify-end gap-3 relative z-10 pt-2 sm:pt-0 border-t sm:border-t-0 border-white/10">
                        <div className="text-right sm:text-left text-xs text-white/80">
                          ...
                          {savedInChapter > 0 && (
                            <span className="text-[10px] bg-amber-400/20 px-2 py-0.5 rounded-full font-bold text-amber-200">
                                  ...
                                  >
                                    <div>
                                      ...
                                      <div className="bg-white dark:bg-gray-800 p-2.5 rounded-xl border border-gray-100 dark:border-gray-700/50 mb-3 text-center dir-rtl">
                                        ...
                                        <p className="text-[10px] text-gray-500 dark:text-gray-400 font-sans dir-ltr italic">
                ...
                >
                  ...
                  <div>
                    <div className="flex items-start justify-between gap-3 mb-3">
                      ...
                      <button
                        ...
                        className={`p-2 rounded-xl border transition-colors cursor-pointer ${
                          isSaved 
                            ? 'bg-amber-500 text-white border-amber-500' 
                            : 'bg-gray-50 dark:bg-gray-700 text-gray-400 border-gray-200 dark:border-gray-600 hover:text-amber-500'
                        }`}
                    ...
                    <div className="bg-gray-50 dark:bg-gray-900/60 p-3 rounded-xl border border-gray-100 dark:border-gray-700/50 mb-4 text-center dir-rtl">
                      <span className="text-[10px] text-gray-400 dark:text-gray-500 block mb-1 dir-ltr font-sans uppercase font-bold">{t('shams.card.majorInvocations', 'Invocations majeures')}</span>
                      <p className="text-sm font-bold text-amber-900 dark:text-amber-200 font-arabic leading-snug">
                        {secret.divineNameAr}
                      </p>
                      <p className="text-[11px] text-gray-500 dark:text-gray-400 font-sans dir-ltr mt-0.5 italic">
                        {secret.divineNamePhonetic}
                      </p>
                    </div>
                  </div>
            ...
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div className="bg-white dark:bg-gray-800 p-3.5 rounded-xl border border-gray-100 dark:border-gray-700">
                  <span className="text-[10px] font-bold uppercase text-gray-400">{t('shams.generator.recommendedDivineName', 'Nom Divin Recommandé')}</span>
                ...
                <div className="bg-white dark:bg-gray-800 p-3.5 rounded-xl border border-gray-100 dark:border-gray-700">
                  <span className="text-[10px] font-bold uppercase text-gray-400">{t('shams.generator.khadimRuhani', 'Khadim Rūhāni (Ange Céleste)')}</span>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-3xl border border-gray-150 dark:border-gray-700 p-6 shadow-sm">
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse min-w-[550px]">
              <thead>
                <tr className="border-b border-gray-200 dark:border-gray-700 text-[11px] font-extrabold uppercase text-gray-400">
                    ...
                    <tr key={idx} className="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                      ...
                      <td className="py-2 px-3">
                        {item.lum ? (
                          ...
                          <span className="text-[10px] text-gray-400">{t('shams.huruf.standard', 'Standard')}</span>
                        )}
                      </td>
                    </tr>
                  );
            ...
            >
              <div className="flex items-center justify-between border-b border-gray-100 dark:border-gray-700 pb-3 mb-4">
                ...
                <button
                  ...
                  className="p-2 rounded-full text-gray-400 hover:text-gray-600 dark:hover:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700"
                >
                  <X size={20} />
                </button>
              </div>
              ...
              <div className="space-y-4 text-xs sm:text-sm">
                ...
                <div className="p-4 bg-gray-50 dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-700 text-center dir-rtl">
                  <span className="text-[10px] text-gray-400 uppercase font-bold block mb-1 dir-ltr">{t('shams.modal.sacredInvocation', "L'Invocation Sacrée")}</span>
                ...
                <div className="grid grid-cols-2 gap-3 text-xs bg-gray-50 dark:bg-gray-900 p-3 rounded-xl">
                  <div>
                    <span className="text-gray-400 font-bold block">{t('shams.modal.momentHeading', 'Moment Propice :')}</span>
                    <span className="text-gray-800 dark:text-gray-200 font-medium">{getSecretOptimalTime(selectedSecret, language)}</span>
                  </div>
                  <div>
                    <span className="text-gray-400 font-bold block">{t('shams.modal.incenseHeading', 'Encens Recommandé :')}</span>
