  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-4 sm:p-6 lg:p-8 safe-area-pt pb-24">
      <div className="mb-6">
        ...
        <p className="text-gray-500 dark:text-gray-400 mt-1 text-xs sm:text-sm break-words leading-relaxed">{t("tools.ilm-jafar.description")}</p>
      </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-3.5 sm:p-5 mb-5">
        <label className="block text-[11px] font-bold text-gray-400 dark:text-gray-500 uppercase tracking-wider mb-2 flex items-center gap-1.5">
        ...
        >
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div className="bg-gray-50 dark:bg-gray-900 rounded-xl p-3 sm:p-4 border border-gray-100 dark:border-gray-800">
              <h3 className="text-[10px] sm:text-xs font-bold text-gray-400 dark:text-gray-500 uppercase tracking-wider mb-3 border-b border-gray-200/60 dark:border-gray-800/60 pb-1.5 break-words">
