...
Invocation : ${result.azimaText}`;
  ...
  return (
    <div className="max-w-4xl mx-auto p-4 sm:p-6 lg:p-8 safe-area-pt pb-24">
      <div className="flex items-start gap-3 sm:gap-4 mb-6 sm:mb-8 shrink-0 w-full min-w-0">
        ...
        <div className="min-w-0 flex-1">
          <h1 className="text-lg sm:text-2xl font-bold text-gray-900 dark:text-white flex items-start sm:items-center gap-2 leading-tight">
            ...
            <span className="break-words">{t("khouddamPage.title", "Détecteur de Khouddam & Alignement Angélique")}</span>
          </h1>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-gradient-to-br from-indigo-600 via-indigo-700 to-purple-800 rounded-3xl p-6 sm:p-8 text-white shadow-xl relative overflow-hidden">
              ...
              <div className="text-4xl sm:text-5xl font-bold font-arabic my-4 text-amber-800 dark:text-amber-200" dir="rtl">
                {result.angelicName}
              </div>
            ...
            <div className="bg-gradient-to-br from-amber-600 via-orange-600 to-red-800 rounded-3xl p-6 sm:p-8 text-white shadow-xl relative overflow-hidden">
              <div className="absolute top-0 right-0 w-32 h-32 bg-white opacity-10 rounded-bl-full"></div>
              <span className="text-xs uppercase tracking-widest text-amber-800 dark:text-amber-200 font-bold block mb-1">
                {t("khouddamPage.earthlyServant", "Le Serviteur Terrestre (Al-Khadim Al-Ardi)")}
              </span>
              <p className="text-amber-800 dark:text-amber-200 text-xs mb-4">Adad : {result.terrestrialAdad}</p>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-3xl p-6 sm:p-8 border border-gray-100 dark:border-gray-700 shadow-sm space-y-6">
            ...
            <div className="bg-amber-950/90 text-amber-100 rounded-2xl p-6 border border-amber-800/50 text-center space-y-3">
              <span className="text-xs uppercase tracking-widest text-amber-700 dark:text-amber-400 font-bold block">
            ...
            {!disableDuaCopy && (
              <div className="flex justify-end">
                ...
                >
                  {copied ? <Check size={16} className="text-amber-800 dark:text-amber-200" /> : <Copy size={16} />}
