      ...
      <div className="mb-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-4">
          <div>
            ...
            <p className="text-gray-500 dark:text-gray-400 mt-1 text-xs sm:text-base">{labels.subtitle}</p>
          </div>
                ...
                <div className="relative z-10 w-full">
                  ...
                  <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 sm:gap-6 mb-6 min-w-0">
                    <div className="min-w-0">
                      ...
                      <p className="text-xl sm:text-3xl font-arabic text-amber-300 mt-1 break-words" dir="rtl">{activeMansion.arabic}</p>
                    </div>
                    ...
                    return (
                      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2.5 sm:gap-3 mb-6">
                        <div className="bg-indigo-950/60 rounded-xl p-3 sm:p-3.5 border border-indigo-800/60 min-w-0 break-words">
                          ...
                          <span className="text-xs font-arabic text-amber-300 block break-words">{extra.angelAr}</span>
                        </div>
                        <div className="bg-indigo-950/60 rounded-xl p-3 sm:p-3.5 border border-indigo-800/60 min-w-0 break-words">
                          ...
                          <span className="text-xs font-arabic text-amber-300 block break-words">{extra.asmaAr}</span>
                        </div>
                        <div className="bg-indigo-950/60 rounded-xl p-3 sm:p-3.5 border border-indigo-800/60 min-w-0 break-words">
                          <span className="text-[11px] text-indigo-300 font-semibold block mb-0.5">{labels.incense}</span>
                          <span className="text-xs font-bold text-amber-200 block break-words">{incenseName}</span>
                        </div>
                        <div className="bg-indigo-950/60 rounded-xl p-3 sm:p-3.5 border border-indigo-800/60 min-w-0 break-words">
                    ...
                    return (
                      <div className="bg-gradient-to-r from-amber-950/40 via-indigo-950/60 to-emerald-950/40 rounded-xl sm:rounded-2xl p-4 sm:p-5 mb-6 border border-amber-500/30 min-w-0">
                        <div className="flex justify-between items-center gap-2 mb-2">
                          <h3 className="text-amber-300 font-bold text-xs sm:text-base flex items-center gap-2">
                            <BookOpen size={18} className="text-amber-400 shrink-0" /> {labels.wird}
                          </h3>
                          <span className="bg-amber-500/20 text-amber-300 font-mono text-xs font-bold px-2 py-0.5 rounded-lg border border-amber-500/30 shrink-0">
                            {extra.wirdCount}x
                          </span>
                        </div>
                        <p className="text-lg sm:text-2xl font-arabic text-amber-200 text-center my-3 leading-loose break-words" dir="rtl">
                          {extra.wirdAr}
                        </p>
            ...
            <div className="flex flex-col md:flex-row items-stretch md:items-center justify-between gap-3 sm:gap-4 min-w-0">
              ...
              <div className="flex flex-wrap items-center gap-2 sm:gap-3">
                <div className="flex items-center gap-1 text-xs max-w-full min-w-0">
                  <span className="text-gray-500 dark:text-gray-400 font-semibold shrink-0">{labels.filterNature}</span>
                  <select
                    value={natureFilter}
                ...
                <div className="flex items-center gap-1 text-xs max-w-full min-w-0">
                  <span className="text-gray-500 dark:text-gray-400 font-semibold shrink-0">{labels.filterElem}</span>
                  <select
                    value={elementFilter}
              ...
              {filteredMansions.map((mansion) => {
                ...
                return (
                  ...
                  >
                    ...
                    <p className="text-base sm:text-xl font-arabic text-gray-500 dark:text-gray-400 text-right mt-1 break-words min-w-0" dir="rtl">{locM.arabic}</p>
                  </button>
                );
              })}
            </div>
      ...
      {activeTab === 'advisor' && (
        <div className="bg-white dark:bg-gray-800 rounded-2xl p-4 sm:p-6 shadow-sm border border-gray-200 dark:border-gray-700 max-w-full overflow-hidden">
          <div className="mb-6">
            ...
            <p className="text-gray-500 dark:text-gray-400 text-xs sm:text-sm mt-1 break-words">{labels.advisorSub}</p>
          </div>
      ...
      {activeTab === 'calculator' && (
        <div className="bg-white dark:bg-gray-800 rounded-2xl p-4 sm:p-6 shadow-sm border border-gray-200 dark:border-gray-700 max-w-full overflow-hidden">
          <div className="mb-6">
            ...
            <p className="text-gray-500 dark:text-gray-400 text-xs sm:text-sm mt-1 break-words">{labels.calcSub}</p>
          </div>
            ...
            >
              <div className="flex flex-col sm:flex-row justify-between items-start gap-3 mb-4">
                <div className="min-w-0">
                  ...
                  <p className="text-lg sm:text-xl font-arabic text-amber-300 mt-1 break-words" dir="rtl">{calcResultMansion.arabic}</p>
                </div>
                <button
                  onClick={() => {
                ...
                return (
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5 text-xs">
                    ...
                    <div className="bg-indigo-900/30 p-2.5 rounded-lg border border-indigo-800/40 min-w-0">
                      ...
                      <span className="font-bold text-amber-300 block mt-0.5 break-words">{extra.angelFr} ({extra.angelAr})</span>
                    </div>
                    <div className="bg-indigo-900/30 p-2.5 rounded-lg border border-indigo-800/40 min-w-0">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl p-4 sm:p-6 shadow-sm border border-gray-200 dark:border-gray-700 max-w-full overflow-hidden">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
            <div>
              ...
              <p className="text-gray-500 dark:text-gray-400 text-xs sm:text-sm mt-1 break-words">{labels.scrollSub}</p>
            </div>

            <button
              onClick={handleCopyScrollText}
              className="px-4 py-2.5 bg-amber-600 hover:bg-amber-700 text-white font-bold text-xs sm:text-sm rounded-xl shadow-md transition-all flex items-center gap-2 cursor-pointer self-start sm:self-auto shrink-0"
            >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 mb-6">
                  ...
                  <div className="space-y-2.5 sm:space-y-3 text-xs sm:text-sm">
                    ...
                    <div className="flex items-center justify-between gap-2 border-b border-[#d4af37]/20 pb-1.5 min-w-0">
                      ...
                      <span className="font-mono text-xs break-words text-right">{extra.degree}</span>
                    </div>
                  </div>
                </div>
