      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 dark:text-gray-300 mt-1">{txt.desc}</p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <div className="flex items-center gap-3">
                ...
                <span className="text-2xl font-bold font-arabic text-amber-800 dark:text-amber-200" dir="rtl">
            ...
            <div className="bg-white/10 p-3 rounded-2xl border border-white/10 space-y-1.5 text-xs">
              <div>
                ...
                <strong className="text-amber-800 dark:text-amber-300 font-bold">{liveInfo.activeHour.planet.angel}</strong>
              </div>
              <div>
      ...
      <div className="flex bg-gray-100 dark:bg-gray-800 p-1 rounded-xl mb-6">
        <button
          ...
          className={`flex-1 py-2.5 rounded-lg text-sm font-bold transition-all flex items-center justify-center gap-2 cursor-pointer ${
            ...
            : 'text-gray-500 dark:text-gray-300 hover:text-gray-700 dark:hover:text-gray-800 dark:text-gray-200'
          }`}
        >
