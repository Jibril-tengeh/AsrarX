...
export default function RajmaCharms() {
  ...
  return (
    <div ref={pageRef} className="min-h-screen bg-gray-950 text-gray-100 py-4 sm:py-10 px-3 sm:px-4 lg:px-8 max-w-7xl mx-auto min-w-0 w-full overflow-x-hidden selection:bg-purple-500 selection:text-white">
      {/* Top Header Navigation */}
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6 border-b border-purple-900/40 pb-6 min-w-0 w-full max-w-full">
        <div className="min-w-0 w-full sm:w-auto">
          <Link 
            to="/tools" 
            className="inline-flex items-center gap-2 text-sm text-purple-400 hover:text-purple-300 font-medium mb-2 transition-colors"
          >
            <ArrowLeft size={16} />
          ...
          <h1 className="text-xl sm:text-4xl font-black bg-gradient-to-r from-amber-200 via-purple-300 to-amber-400 bg-clip-text text-transparent flex items-center gap-2 sm:gap-3 break-words">
            <Sparkles className="text-amber-400 animate-pulse shrink-0" size={28} />
          ...
          <p className="text-xs sm:text-sm text-purple-300/80 mt-1 max-w-2xl break-words">
            {language === 'fr'
          ...
          <button
            ...
            className={`px-3 py-2 rounded-xl text-xs font-bold border transition-all flex items-center gap-1.5 ${
              layoutCheckMode
                ...
                : 'bg-gray-900/80 text-purple-300 border-purple-800/60 hover:text-white hover:bg-gray-800'
            }`}
      ...
      {layoutCheckMode && (
        <div className={`p-4 rounded-2xl mb-6 border text-xs flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 min-w-0 w-full max-w-full shadow-lg ${
          ...
          <div className="font-mono text-[11px] bg-black/50 px-3 py-1.5 rounded-xl border border-white/10 shrink-0">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start min-w-0 w-full max-w-full overflow-hidden sm:overflow-visible">
              ...
              <motion.div
                ...
                className={`p-3.5 sm:p-4 rounded-2xl border transition-all cursor-pointer relative overflow-hidden min-w-0 w-full max-w-full ${
                  isSelected
                    ...
                    : 'bg-gray-900/70 hover:bg-gray-900 border-gray-800/80 text-gray-300 hover:border-gray-700'
                }`}
              >
                <div className="flex items-center justify-between gap-2 mb-2 min-w-0 w-full">
                  <div className="flex items-center gap-2 min-w-0 shrink">
                    <span className="w-7 h-7 rounded-lg bg-purple-950 border border-purple-700/60 flex items-center justify-center text-xs font-bold text-amber-400 shrink-0">
                      #{charm.id}
                    </span>
                    <span className="text-xs px-2.5 py-0.5 rounded-full bg-purple-900/50 text-purple-300 border border-purple-700/40 truncate max-w-[130px] sm:max-w-none">
                      {charmCategoryName}
                    </span>
                  </div>
                ...
                <div className="flex items-start justify-between gap-2 min-w-0 w-full">
                  <div className="min-w-0 w-full">
                    <h3 className="text-sm font-bold text-white group-hover:text-purple-300 transition-colors break-words">
                      {charmTitle}
                    </h3>
                    <p className="text-xs text-purple-300/70 mt-1 font-serif dir-rtl text-right break-words">
                      {charm.arabicTitle}
                    </p>
                  </div>
                </div>

                <div className="mt-3 pt-2 border-t border-purple-900/30 flex items-center justify-between gap-2 text-[11px] text-gray-400 min-w-0 w-full">
                  <span className="truncate">Poids Abjad: <strong className="text-amber-400 font-mono">{charm.abjadValue}</strong></span>
                  <span className="truncate">Ange: <strong className="text-purple-300">{charm.celestialAngel}</strong></span>
                </div>
              </motion.div>
            );
          })}
        ...
        <div className="lg:col-span-7 bg-gray-900/90 rounded-3xl border border-purple-900/50 p-3.5 sm:p-6 shadow-2xl relative min-w-0 w-full max-w-full overflow-hidden">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 border-b border-purple-900/40 pb-4 mb-6 min-w-0 w-full max-w-full">
            <div className="min-w-0 w-full sm:w-auto">
              <div className="flex flex-wrap items-center gap-1.5 sm:gap-2 mb-1 min-w-0 w-full">
                <span className="text-xs font-bold text-amber-400 bg-amber-400/10 px-2.5 py-1 rounded-full border border-amber-500/30 truncate max-w-full">
                  {getCharmCategoryName(selectedCharm, language)}
                </span>
                <span className="text-xs text-purple-300 bg-purple-900/30 px-2.5 py-1 rounded-full border border-purple-700/30 whitespace-nowrap">
                  Abjad : <strong className="text-amber-300 font-mono">{selectedCharm.abjadValue}</strong>
                </span>
                <span className="text-xs text-amber-300/80 bg-amber-950/40 px-2.5 py-1 rounded-full border border-amber-800/40 font-mono truncate max-w-full">
              ...
              <p className="text-sm sm:text-base text-amber-300 font-serif dir-rtl mt-0.5 break-words">
              ...
              <button
                ...
                className={`p-2 sm:p-2.5 rounded-xl border transition-all text-xs font-semibold flex items-center gap-1.5 ${
                  isPlayingAudio
                    ...
                    : 'bg-purple-900/40 text-purple-200 border-purple-700/50 hover:bg-purple-800/60'
                }`}
          ...
          {/* Sub Navigation Tabs */}
          <div className="flex bg-gray-950 p-1 rounded-2xl border border-purple-900/40 mb-6 overflow-x-auto no-scrollbar min-w-0 w-full max-w-full gap-1">
            <button
            ...
            <div className="space-y-6 min-w-0 w-full">
                ...
                <div className="mt-4 text-center space-y-1">
                  <p className="text-xs text-amber-300/80 font-mono">
                    {language === 'fr' 
                      ? 'Formule Talsam: ' 
                      : 'Talsam Formula: '} 
                    <strong className="text-amber-200">{selectedCharm.talsamFormula}</strong>
                  </p>
                  <p className="text-[11px] text-purple-300/70 font-serif dir-rtl">
                    {selectedCharm.celestialAngelAr} • {selectedCharm.terrestrialKhadimAr}
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-wrap gap-3 justify-center">
                ...
                <button
                  ...
                  className="px-5 py-2.5 rounded-2xl bg-purple-900/60 hover:bg-purple-800 text-purple-200 border border-purple-700/60 font-bold text-xs flex items-center gap-2 transition-all"
                >
                  <Feather size={16} />
          ...
          {activeTab === 'incantation' && (
            <div className="space-y-5 min-w-0 w-full">
              <div className="bg-black/60 p-5 rounded-2xl border border-purple-900/40 text-center min-w-0 w-full">
                ...
                <p className="text-xl sm:text-2xl font-serif text-amber-200 dir-rtl leading-relaxed my-3 break-words">
                  {selectedCharm.verseAr}
                </p>
                <p className="text-xs sm:text-sm text-purple-200 italic mb-2 break-words">
                ...
                <button
                  ...
                  className="mt-4 px-4 py-2 rounded-xl bg-purple-900/40 hover:bg-purple-800/60 text-purple-300 text-xs font-semibold inline-flex items-center gap-2 border border-purple-700/40 transition-colors"
                >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 min-w-0 w-full">
                <div className="bg-gray-950 p-4 rounded-2xl border border-gray-800 min-w-0">
                  <div className="flex items-center gap-2 text-amber-400 text-xs font-bold mb-1">
                    <Sun size={16} />
                    <span>{language === 'fr' ? 'Nombre de Répétitions (Riyada)' : language === 'ha' ? 'Adadin Karanto' : 'Repetition Count'}</span>
                  </div>
                  <p className="text-2xl font-black text-white font-mono">
                    {selectedCharm.repCount} <span className="text-xs font-normal text-gray-400">fois / times</span>
                  </p>
                ...
                <div className="bg-gray-950 p-4 rounded-2xl border border-gray-800 min-w-0">
                  ...
                  <p className="text-[11px] text-gray-400 mt-1 break-words">
                    ...
                    <strong className="text-amber-300">{getCharmIncense(selectedCharm, language)}</strong>
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4 min-w-0 w-full">
              ...
              <div className="space-y-2.5 min-w-0 w-full">
                {getCharmBenefitsList(selectedCharm, language).map((benefit, bIdx) => (
                  <div key={bIdx} className="p-3.5 bg-black/50 rounded-2xl border border-purple-900/40 flex items-start gap-3 min-w-0 w-full">
                    <div className="w-6 h-6 rounded-lg bg-amber-500/10 border border-amber-500/30 text-amber-400 flex items-center justify-center text-xs font-bold shrink-0 mt-0.5">
                      {bIdx + 1}
                    </div>
                    <p className="text-xs sm:text-sm text-gray-200 leading-relaxed break-words min-w-0 flex-1">
                      {benefit}
                    </p>
                  </div>
                ))}
          ...
          {activeTab === 'science' && (
            <div className="space-y-4 min-w-0 w-full">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 min-w-0 w-full">
                <div className="bg-black/60 p-4 rounded-2xl border border-purple-900/40 min-w-0">
                  <span className="text-[11px] text-purple-400 font-semibold block">Ange Céleste (Mala'ika)</span>
                  <p className="text-base font-bold text-white mt-1">{selectedCharm.celestialAngel}</p>
                  <p className="text-sm font-serif text-amber-300 dir-rtl mt-0.5">{selectedCharm.celestialAngelAr}</p>
                </div>

                <div className="bg-black/60 p-4 rounded-2xl border border-purple-900/40 min-w-0">
                  <span className="text-[11px] text-amber-400 font-semibold block">Serviteur Terrestre (Khadim)</span>
                  <p className="text-base font-bold text-white mt-1">{selectedCharm.terrestrialKhadim}</p>
                  <p className="text-sm font-serif text-amber-300 dir-rtl mt-0.5">{selectedCharm.terrestrialKhadimAr}</p>
                </div>
              </div>

              <div className="bg-gray-950 p-4 rounded-2xl border border-gray-800 min-w-0">
                <div className="flex items-center justify-between text-xs text-gray-300 mb-2 min-w-0">
                  <span>Élément Canonique : <strong className="text-amber-400">{getCharmElement(selectedCharm, language)}</strong></span>
                  <span>Fréquence Sacrée : <strong className="text-purple-300 font-mono">{selectedCharm.frequencyHz} Hz</strong></span>
                </div>
          ...
          {activeTab === 'calendar' && (
            <div className="space-y-6 min-w-0 w-full">
              ...
              <div className="bg-gray-950 p-4 rounded-2xl border border-amber-500/40 min-w-0 w-full">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mb-3 px-1 min-w-0">
                  <label className="text-xs font-bold text-amber-300 flex items-center gap-1.5 truncate">
                    <Layers size={15} className="shrink-0 text-amber-400" />
                    <span>
                      {language === 'fr' 
                  ...
                  <span className="text-xs font-mono font-bold text-amber-300 bg-amber-950/90 px-3 py-1 rounded-full border border-amber-700/80 shrink-0 self-start sm:self-auto">
                      ...
                      <button
                        ...
                        className={`px-3 py-2 rounded-xl text-xs font-bold whitespace-nowrap transition-all border shrink-0 flex items-center gap-1.5 ${
                          isSelectedMonth
                            ...
                            : 'bg-gray-900/90 text-gray-300 border-gray-800 hover:text-amber-200 hover:bg-gray-800'
                        }`}
                      >
                        <span className="font-mono text-[10px] opacity-80 px-1.5 py-0.5 rounded bg-black/30">M#{charm.id}</span>
                        <span>{monthName}</span>
                      </button>
                    );
                  })}
              ...
              <div className="bg-gradient-to-r from-purple-950 via-gray-950 to-amber-950 p-5 rounded-2xl border border-amber-500/40 relative overflow-hidden min-w-0 w-full shadow-lg">
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 min-w-0">
                  <div className="min-w-0">
                    <span className="text-xs font-bold uppercase tracking-wider text-amber-400 bg-amber-400/10 px-3 py-1 rounded-full border border-amber-500/30 inline-block">
                      {getCharmMonthName(selectedCharm, language)}
                    </span>
                    ...
                    <p className="text-xs text-purple-200/90 mt-1 break-words">
                  ...
                  <div className="text-right shrink-0">
                    ...
                    <span className="text-sm font-bold text-amber-300">{selectedCharm.celestialAngel}</span>
                    <span className="text-xs text-amber-400/90 block dir-rtl" style={{ fontFamily: '"Amiri Quran", "Uthmani", "Scheherazade New", "Amiri", "Traditional Arabic", serif', direction: 'rtl' }}>
              ...
              <div className="min-w-0 w-full">
                <div className="flex items-center justify-between mb-2 min-w-0">
                  ...
                  <span className="text-xs font-mono font-bold text-purple-300 bg-purple-950 px-2.5 py-0.5 rounded-full border border-purple-800 shrink-0">
                    {language === 'fr' ? `Jour #${selectedDay} / 30` : language === 'ha' ? `Rana #${selectedDay} / 30` : `Day #${selectedDay} / 30`}
                  </span>
                </div>

                <div className="grid grid-cols-6 sm:grid-cols-10 lg:grid-cols-15 gap-1.5 p-2 bg-gray-950 rounded-2xl border border-purple-900/40 min-w-0 w-full max-w-full overflow-x-auto">
                      ...
                      <button
                        ...
                        className={`py-2 rounded-xl text-xs font-bold transition-all relative shrink-0 ${
                          isSelected
                            ...
                            : isFullMoon
                            ? 'bg-purple-900/60 text-amber-200 border border-amber-500/40 hover:bg-purple-800'
              ...
              {(() => {
                ...
                return (
                  <div ref={dailySealRef} className="space-y-6 min-w-0 w-full p-2 bg-gray-950/40 rounded-2xl">
                    {/* Top Stats Bar */}
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 min-w-0 w-full">
                      <div className="bg-black/80 p-4 rounded-2xl border border-amber-500/30 min-w-0">
                        <span className="text-[11px] text-amber-400 font-semibold block uppercase">
                          {language === 'fr' ? `Répétition du Jour #${selectedDay}` : language === 'ha' ? `Maimaitawa na Rana #${selectedDay}` : `Daily Count #${selectedDay}`}
                        </span>
                        <p className="text-xl font-black text-amber-200 font-mono mt-1">
                          {dailyRepCount} <span className="text-xs font-normal text-gray-400">{language === 'fr' ? 'fois' : language === 'ha' ? 'sau' : 'times'}</span>
                        </p>
                      ...
                      <div className="bg-black/80 p-4 rounded-2xl border border-purple-500/30 min-w-0">
                        <span className="text-[11px] text-purple-400 font-semibold block uppercase">
                        ...
                        <p className="text-sm font-bold text-white mt-1 flex items-center gap-1.5">
                          <Moon size={16} className="text-purple-300 shrink-0" />
                          <span>{moonPhase}</span>
                        </p>
                        <p className="text-[10px] text-gray-400 mt-1 break-words">
                      ...
                      <div className="bg-black/80 p-4 rounded-2xl border border-emerald-500/30 min-w-0">
                    ...
                    <div className="bg-black/70 p-5 rounded-2xl border border-amber-500/40 space-y-4 min-w-0 w-full">
                      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 border-b border-amber-500/20 pb-3 min-w-0">
                        <div>
                          <span className="text-[10px] uppercase font-bold tracking-wider text-amber-400 bg-amber-500/10 px-2.5 py-0.5 rounded-full border border-amber-500/30">
                            {language === 'fr' ? `Sceau Spécifique du Jour #${selectedDay}` : language === 'ha' ? `Hatimin Ranar #${selectedDay}` : `Specific Daily Seal #${selectedDay}`}
                          </span>
                          <h4 className="text-base sm:text-lg font-bold text-amber-200 mt-1 break-words">
                            {sealTitle}
                          </h4>
                        </div>
                        <div className="text-right shrink-0">
                          <span className="text-xs font-mono font-bold text-amber-300 bg-amber-950/80 px-3 py-1 rounded-lg border border-amber-700/50 block">
                            {dailyData.seal.talsamCode}
                          </span>
                          <span className="text-[10px] text-gray-400 block mt-0.5">Poids Abjad : {dailyData.seal.abjadValue}</span>
                        </div>
                      </div>

                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 items-center min-w-0 w-full">
                        {/* Daily Magic Square Visual Render */}
                        <div className="bg-gray-950 p-4 rounded-xl border border-purple-900/50 flex flex-col items-center justify-center">
                          <span className="text-xs font-bold text-amber-300 font-quran dir-rtl mb-2" style={{ fontFamily: '"Amiri Quran", "Uthmani", "Scheherazade New", "Amiri", "Traditional Arabic", serif', direction: 'rtl' }}>{dailyData.seal.titleAr}</span>
                            ...
                            {dailyData.seal.grid.map((row, rIdx) => (
                              <React.Fragment key={rIdx}>
                                {row.map((cell, cIdx) => (
                                  <div
                                    key={cIdx}
                                    className="bg-black/90 text-amber-200 font-mono font-bold text-center py-2.5 text-sm rounded border border-amber-500/30 shadow-inner"
                                  >
                                    {cell}
                                  </div>
                                ))}
                        ...
                        {/* Seal Description */}
                        <div className="space-y-2 text-xs text-gray-300 min-w-0">
                    ...
                    <div className="bg-gray-950 p-5 rounded-2xl border border-gray-800 space-y-3 min-w-0 w-full">
                      <div className="flex items-center justify-between border-b border-gray-800 pb-2.5 min-w-0">
                        ...
                        <span className="text-sm font-quran font-bold text-amber-300 dir-rtl" style={{ fontFamily: '"Amiri Quran", "Uthmani", "Scheherazade New", "Amiri", "Traditional Arabic", serif', direction: 'rtl' }}>{dailyData.jinn.nameAr}</span>
                      </div>

                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 min-w-0 w-full">
                        <div className="p-3 bg-black/60 rounded-xl border border-purple-900/40 min-w-0">
                          <span className="text-[10px] text-purple-400 block font-semibold">{language === 'fr' ? 'Nom Translitéré :' : language === 'ha' ? 'Sunan Garfani :' : 'Phonetic Name:'}</span>
                          <span className="text-sm font-bold text-white block mt-0.5">{dailyData.jinn.namePhonetic}</span>
                          <span className="text-xs text-amber-300 block mt-1 font-semibold">{jinnTitle}</span>
                        </div>
                        <div className="p-3 bg-black/60 rounded-xl border border-purple-900/40 min-w-0">
                          <span className="text-[10px] text-purple-400 block font-semibold">{language === 'fr' ? 'Attribution & Rôle Spirituel :' : language === 'ha' ? 'Matsayi da Aikin Ruhani :' : 'Spiritual Function:'}</span>
                          <p className="text-xs text-gray-300 mt-1 leading-relaxed break-words">{jinnRole}</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-gray-950 p-5 rounded-2xl border border-gray-800 space-y-3 min-w-0 w-full">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 min-w-0 w-full">
                        <div className="p-3 bg-black/60 rounded-xl border border-emerald-900/40 min-w-0">
                          ...
                          <span className="text-xs text-gray-300 block mt-1 leading-relaxed break-words">{plantUsage}</span>
                        </div>
                        <div className="p-3 bg-black/60 rounded-xl border border-emerald-900/40 min-w-0">
                    ...
                    <div className="bg-black/80 p-5 rounded-2xl border border-purple-900/60 space-y-3 text-center min-w-0 w-full">
                      <span className="text-[10px] uppercase font-bold tracking-wider text-purple-400 bg-purple-500/10 px-3 py-0.5 rounded-full border border-purple-500/30">
                        {language === 'fr' ? 'Azima Sacrée & Incantation du Jour' : language === 'ha' ? 'Azima da Maimaitawa na Ranar' : 'Sacred Daily Azima & Incantation'}
                      </span>

                      <p className="text-lg sm:text-2xl font-quran text-amber-200 dir-rtl leading-relaxed my-2 break-words" style={{ fontFamily: '"Amiri Quran", "Uthmani", "Scheherazade New", "Amiri", "Traditional Arabic", serif', direction: 'rtl' }}>
                        {dailyData.incantation.azimaAr}
                      </p>

                      <p className="text-xs sm:text-sm text-purple-200 italic break-words">
                      ...
                      <div className="inline-block px-4 py-1.5 bg-amber-500/10 border border-amber-500/30 rounded-full text-xs font-bold text-amber-300">
                    ...
                    <div className="bg-gray-950 p-5 rounded-2xl border border-gray-800 space-y-3 min-w-0 w-full">
                      ...
                      <div className="space-y-2.5">
                        {steps.map((stepText, sIdx) => (
                          <div key={sIdx} className="p-3 bg-black/50 rounded-xl border border-purple-900/30 flex items-start gap-3 min-w-0 w-full">
                            <div className="w-6 h-6 rounded-lg bg-amber-500/20 text-amber-400 flex items-center justify-center text-xs font-bold shrink-0 mt-0.5">
                              {sIdx + 1}
                            </div>
                            <p className="text-xs text-gray-200 leading-relaxed break-words min-w-0 flex-1">
                              {stepText}
                            </p>
                          </div>
                        ))}
            ...
            <div className="space-y-4 text-center min-w-0 w-full max-w-full font-serif">
              ...
              <div className="p-3 sm:p-4 bg-amber-950/90 rounded-2xl border-2 border-amber-800/80 shadow-md relative overflow-hidden my-2 flex flex-col items-center justify-center">
                ...
                <div className="mb-2 text-center">
                  <span className="text-[10px] font-sans font-bold tracking-widest uppercase text-amber-300/80 block">
                    {language === 'fr' ? 'Khatim Sacré & Wafq Mystique' : language === 'ha' ? 'Hatimi da Wafq na Asiri' : 'Sacred Khatim & Mystical Wafq'}
                  </span>
                  <p className="text-lg sm:text-xl font-black font-serif dir-rtl text-amber-200 mt-0.5 break-words">
                    {selectedCharm.arabicTitle}
                  </p>
                </div>
                ...
                <div className="mt-2 pt-2 border-t border-amber-700/50 text-center w-full">
                  <span className="text-[10px] font-sans font-bold text-amber-300 uppercase tracking-widest block mb-1">
                  ...
                  <div className="inline-block bg-amber-900/80 px-4 py-1 rounded-lg border border-amber-700/60 shadow-sm">
                    <span className="text-base sm:text-lg font-serif font-black text-amber-200 dir-rtl whitespace-nowrap tracking-normal">
            ...
            content={
              <div className="space-y-4 text-center min-w-0 w-full max-w-full font-serif">
                ...
                <div className="p-3 sm:p-4 bg-amber-950/90 rounded-2xl border-2 border-amber-800/80 shadow-md relative overflow-hidden my-2 flex flex-col items-center justify-center text-amber-100">
                  <span className="text-[10px] font-sans font-bold tracking-widest uppercase text-amber-300 block mb-1">
                    {language === 'fr' ? `Khatim Sacré du Jour #${selectedDay}` : language === 'ha' ? `Hatimin Ranar #${selectedDay}` : `Sacred Daily Khatim #${selectedDay}`}
                  </span>
                  <p className="text-lg font-black font-serif dir-rtl text-amber-200 mb-2">
                      ...
                      <tbody>
                        {dailyData.seal.grid.map((row, rIdx) => (
                          <tr key={rIdx} className="border-b border-amber-800/60 last:border-b-0">
                            {row.map((cell, cIdx) => (
                              <td key={cIdx} className="border-r border-amber-800/60 last:border-r-0 py-2 px-1 text-sm sm:text-base font-bold font-serif text-amber-200 bg-amber-950/40">
                                {cell}
                              </td>
                            ))}
                          </tr>
                  ...
                  <div className="mt-2 text-xs font-mono text-amber-300 bg-amber-900/60 px-3 py-1 rounded border border-amber-700/60">
