      ...
      <AnimatePresence>
        {showSavedLibrary && (
          ...
          >
            <div className="flex items-center justify-between pb-3 border-b border-gray-100 dark:border-gray-700">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="p-1.5 text-gray-600 dark:text-gray-300 hover:text-gray-600 dark:hover:text-gray-800 dark:text-gray-200 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-700 transition-all"
                >
                  <X size={16} />
                </button>
              </div>
            ...
            {savedSeals.length === 0 ? (
              <div className="py-8 text-center text-xs text-gray-500 dark:text-gray-300 space-y-2">
                      ...
                      <div className="flex items-start justify-between gap-2">
                        <div className="flex items-center gap-2">
                          ...
                          <div>
                            ...
                            <span className="text-[10px] text-gray-500 dark:text-gray-300 font-serif">
                              {seal.celestialAngel}
                            </span>
                          </div>
                        </div>
                        ...
                        <button
                          ...
                          className="p-1 rounded-lg text-gray-600 dark:text-gray-300 hover:text-rose-500 hover:bg-rose-50 dark:hover:bg-rose-950/50 transition-all opacity-60 group-hover:opacity-100"
          ...
          <div className="bg-white dark:bg-gray-800 p-5 sm:p-6 rounded-3xl border border-gray-100 dark:border-gray-700 shadow-sm space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3 text-xs">
              <div className="p-3 bg-gray-50 dark:bg-gray-900/60 rounded-2xl border border-gray-200/80 dark:border-gray-700">
                <span className="text-gray-500 dark:text-gray-300 block mb-0.5 text-[11px]">
        ...
        <div className="lg:col-span-5 space-y-4">
          ...
          <div className="bg-white dark:bg-gray-800 p-4 rounded-3xl border border-gray-100 dark:border-gray-700 shadow-xs space-y-3">
            ...
            <div className="flex items-center justify-between pt-2 border-t border-gray-100 dark:border-gray-700 text-xs">
              <span className="text-gray-500 dark:text-gray-300 font-medium">{t('seven-kings.numberDisplay', 'Affichage des chiffres :')}</span>
          ...
          >
            ...
            <div className="text-center mb-2 z-10">
              <span className="text-[11px] font-mono text-amber-700 dark:text-amber-400 uppercase tracking-widest block font-bold">
              ...
              <h3 className="text-lg font-bold text-white font-serif mt-0.5 flex items-center justify-center gap-1.5">
                ...
                <span className="text-amber-700 dark:text-amber-400">({selectedDay.planetSymbol})</span>
              </h3>
              ...
              <button
                ...
                className={`px-2.5 py-1 rounded-xl text-[10px] font-bold transition-all cursor-pointer border ${
                  activeSealSegment === 'outer-ring'
                    ...
                    : 'bg-gray-900/80 text-gray-700 dark:text-gray-300 border-gray-800 hover:border-amber-500/50'
                }`}
              >
            ...
            <AnimatePresence mode="wait">
              {activeSealSegment && (
                <motion.div
                  ...
                  exit={{ opacity: 0, y: 5 }}
                  className="mt-3 p-3.5 bg-amber-950/40 border border-amber-500/40 rounded-2xl text-xs text-amber-800 dark:text-amber-200 z-10 w-full space-y-1 text-left"
                >
                  {activeSealSegment === 'outer-ring' && (
                    <>
                      <div className="font-extrabold text-amber-700 dark:text-amber-400 text-sm flex items-center justify-between">
                        <span>{t('seven-kings.ringTitle', '💫 Anneau des Noms Divins & Rois Célestes')}</span>
                        <button onClick={() => setActiveSealSegment(null)} className="text-gray-600 dark:text-gray-300 hover:text-white">✕</button>
                      </div>
            ...
            <div className="w-full mt-4 z-10 pt-3 border-t border-gray-800/80 space-y-2">
              ...
              {!isPremium && (
                <div className="text-center pt-1">
                  <span className="text-[10px] text-amber-700 dark:text-amber-400/90 font-medium flex items-center justify-center gap-1">
