        ...
        <div className="mb-6">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
            <div>
              ...
              <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 mt-1 break-words">{labels.subtitle}</p>
            </div>
          ...
          {!isCalculated ? (
            <motion.div key="form" initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, scale: 0.97 }}>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-2xl p-4 mb-6 shadow-sm border border-gray-100 dark:border-gray-700">
                <span className="text-xs font-bold text-gray-500 dark:text-gray-400 block mb-2">{labels.presets}</span>
              ...
              {activeTab === 'overview' && (
                <div className="space-y-6 max-w-full">
                    ...
                    <div className="relative z-10">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6 text-center">
                        <div className="bg-white/5 backdrop-blur-md p-4 rounded-2xl border border-white/10">
                          ...
                          <span className="text-2xl sm:text-3xl font-black text-amber-300">{result.score1}</span>
                        </div>
                        <div className="bg-white/5 backdrop-blur-md p-4 rounded-2xl border border-white/10">
                          <span className="text-[11px] text-violet-300 font-semibold uppercase block mb-1">{labels.motherWeight}</span>
                          <span className="text-2xl sm:text-3xl font-black text-amber-300">{result.score2}</span>
                        </div>
                        <div className="bg-gradient-to-r from-violet-600/30 to-purple-600/30 p-4 rounded-2xl border border-violet-500/50 shadow-inner">
                          <span className="text-[11px] text-amber-300 font-bold uppercase block mb-1">{labels.totalWeight}</span>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="bg-slate-900/80 p-4 rounded-2xl border border-violet-500/40 relative overflow-hidden">
                          ...
                          <span className="text-xl sm:text-2xl font-bold font-arabic text-amber-300 block my-1" dir="rtl">{result.angelAr}</span>
                  ...
                  <div className="bg-white dark:bg-gray-800 rounded-2xl p-5 shadow-sm border border-gray-100 dark:border-gray-700">
                    ...
                    <p className="text-xs text-gray-500 dark:text-gray-400 mb-4">{labels.divineNamesDesc}</p>
                      ...
                      {result.matchingNames.map((asma: any, idx: number) => (
                        <div key={idx} className="bg-gray-50 dark:bg-gray-900 p-4 rounded-2xl border border-gray-200 dark:border-gray-700 flex flex-col justify-between">
                          <div>
                            ...
                            <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5 italic">{asma.fr}</p>
                          </div>
                          <div className="mt-3 pt-2 border-t border-gray-200 dark:border-gray-800">
                            <span className="text-[10px] text-gray-400 block">{asma.ref}</span>
                          </div>
                        </div>
                      ))}
                    </div>
              ...
              {activeTab === 'khatim' && (
                <div className="bg-white dark:bg-gray-800 rounded-2xl p-5 sm:p-8 shadow-sm border border-gray-100 dark:border-gray-700 max-w-full">
                  <div className="mb-6">
                    ...
                    <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 mt-1 break-words">{labels.khatimSub}</p>
                  </div>
                  ...
                  <div className="max-w-md mx-auto my-6 bg-gradient-to-br from-amber-950 via-slate-900 to-amber-900 p-4 sm:p-6 rounded-3xl border-4 border-amber-500/40 shadow-2xl text-white text-center">
                    <span className="text-xs font-bold uppercase text-amber-300 tracking-widest block mb-4">
                    ...
                    <div className="grid grid-cols-3 gap-2 sm:gap-3 bg-black/40 p-3 rounded-2xl border border-amber-500/30">
                      {result.wafqGrid.map((row: number[], rIdx: number) => 
                        row.map((cellVal: number, cIdx: number) => (
                          ...
                          >
                            <span className="text-lg sm:text-2xl font-black text-amber-200">{cellVal}</span>
                          </div>
                        ))
                      )}
                    </div>

                    <div className="mt-4 flex justify-between items-center text-xs text-amber-200/80 border-t border-amber-500/30 pt-3">
                      <span>{labels.miftah}: <strong className="text-amber-300">{result.baseVal}</strong></span>
              ...
              {activeTab === 'wird' && (
                <div className="bg-white dark:bg-gray-800 rounded-2xl p-5 sm:p-8 shadow-sm border border-gray-100 dark:border-gray-700 max-w-full">
                  <div className="mb-6">
                    ...
                    <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 mt-1 break-words">{labels.wirdSub}</p>
                  </div>
                  ...
                  <div className="bg-gradient-to-r from-amber-950/20 via-slate-900/30 to-amber-950/20 p-5 rounded-2xl border border-amber-500/30 text-center">
                    ...
                    <p className="text-2xl sm:text-3xl font-arabic text-amber-300 my-3 leading-loose" dir="rtl">
              ...
              {activeTab === 'aura' && (
                <div className="bg-white dark:bg-gray-800 rounded-2xl p-5 sm:p-8 shadow-sm border border-gray-100 dark:border-gray-700 max-w-full">
                  ...
                  <div className="bg-gray-50 dark:bg-gray-900 p-5 rounded-2xl border border-gray-200 dark:border-gray-700 mb-6">
                    <h3 className="text-xs font-bold uppercase text-gray-500 dark:text-gray-400 mb-4">{labels.elementalBalance}</h3>
                ...
                <div className="bg-white dark:bg-gray-800 rounded-2xl p-4 sm:p-8 shadow-sm border border-gray-100 dark:border-gray-700 max-w-full">
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
                    <div>
                      ...
                      <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 mt-1 break-words">{labels.scrollSub}</p>
                    </div>
