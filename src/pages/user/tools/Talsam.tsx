          ...
          >
            ...
            <div className={`relative overflow-hidden rounded-3xl p-8 border border-amber-500/20 bg-gradient-to-b ${themeColor} text-white shadow-2xl text-center`}>
              ...
              <div className="relative z-10 space-y-6">
                <span className="inline-flex items-center gap-1 bg-white/10 backdrop-blur-md px-3 py-1 rounded-full text-xs font-bold uppercase tracking-widest text-amber-800 dark:text-amber-200">
                ...
                <h3 className="text-amber-100 font-extrabold uppercase tracking-widest text-sm flex items-center justify-center gap-2">
                  <Key size={14} className="text-amber-800 dark:text-amber-300" />
              ...
              <div className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-3xl p-6 shadow-sm space-y-6">
                ...
                <div className="space-y-2">
                  <div className="flex justify-between items-center text-xs">
                    <span className="text-gray-500 dark:text-gray-300 font-bold">VALEUR ABJAD GLOBALE DE L'INTENTION</span>
                ...
                <div className="p-4 bg-gray-50 dark:bg-slate-950 rounded-2xl border border-gray-100 dark:border-gray-800 space-y-3">
                  <div className="flex justify-between items-center">
                    <span className="text-xs font-bold text-gray-600 dark:text-gray-300 uppercase">Clé de résonance (Répétitions)</span>
                  ...
                  <div className="flex justify-between items-center text-xs border-t border-gray-100 dark:border-gray-800/80 pt-2">
                    <span className="text-gray-600 dark:text-gray-300">Calcul théurgique</span>
                    <span className="font-mono text-gray-600 dark:text-gray-300">({abjad} x 3) + Somme Noms</span>
                  </div>
                </div>

                {/* Divine Names of Allah matched */}
                <div className="space-y-3">
                  <h4 className="text-xs font-bold text-gray-600 dark:text-gray-300 uppercase tracking-widest flex items-center gap-1.5">
                    ...
                    {divineNames.map((name, i) => (
                      <div key={i} className="flex items-center justify-between p-3 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-100 dark:border-slate-900/50">
                        <div className="space-y-1">
                          ...
                          <p className="text-[10px] text-gray-600 dark:text-gray-300 leading-normal">{name.meaning}</p>
                        </div>
                ...
                {(() => {
                  ...
                  return (
                    <div className="space-y-5">
                      ...
                      <div className="space-y-2">
                        <div className="flex justify-between items-center text-xs">
                          <span className="text-gray-500 dark:text-gray-300 font-bold uppercase tracking-wider">Taux de Charge Spatiale</span>
                      ...
                      <div className="space-y-1 p-3.5 bg-slate-50 dark:bg-slate-950/50 rounded-xl border border-slate-100 dark:border-slate-900/80">
                        <span className="text-[10px] font-bold text-gray-600 dark:text-gray-300 uppercase tracking-widest block mb-1">Recommandation Spécifique</span>
            ...
            <div className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-3xl p-6 sm:p-8 shadow-sm space-y-8">
              <div className="flex items-center gap-3 pb-5 border-b border-gray-100 dark:border-gray-800">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-600 dark:text-gray-300 mt-0.5">La science millénaire de la transmutation spirituelle (Rouhaniyyat)</p>
                </div>
              </div>
