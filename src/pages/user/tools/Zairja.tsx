                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 pt-2">
                    {answer.burujDegrees.map((d, i) => (
                      <div key={i} className="bg-zinc-900/90 border border-purple-900/30 p-2.5 rounded-xl text-center">
                        <span className="text-[10px] text-amber-400 font-bold block">{d.degree}° - {d.sign}</span>
                        <span className="font-arabic text-sm text-purple-200 font-bold block" dir="rtl">{d.signAr} ({d.element})</span>
