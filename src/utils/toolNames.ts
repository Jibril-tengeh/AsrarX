...
const fallbackNames: Record<string, { fr: string; en: string; ha: string }> = {
  ...
  cauris: { fr: 'Tirage des Cauris', en: 'Cowrie Shell Divination', ha: 'Kuri\'ar Farar Kudi' },
  azlam: { fr: 'Tirage des Flèches (Azlam)', en: 'Sacred Arrows (Azlam)', ha: 'Kibiyoyin Asrar' },
  ifa: { fr: 'Oracle Ifa (16 Odus)', en: 'Ifa Oracle (16 Odus)', ha: 'Ifa Mai Tsarki' },
  sikidy: { fr: 'Géomancie Sikidy', en: 'Sikidy Geomancy', ha: 'Sikidy na Madagascar' },
  nakshatras: { fr: 'Nakshatras Védiques', en: 'Vedic Nakshatras', ha: 'Manazilin Indiya' },
  'feng-shui': { fr: 'Boussole Feng Shui & BaGua', en: 'Feng Shui & BaGua', ha: 'Feng Shui da BaGua' },
