...
// We will populate 28 expanded names here in JS objects
const namesData = [
  {
    id: 1,
    nameAr: 'بَرْهَتِيهٍ',
...
4. Activation & Recitation : Lisez la grande invocation (Da'wah) de la Barhatiah puis répétez le nom "Barhatihin" 662 fois en maintenant votre regard fixé sur l'écriture.
...
5. Amfani: Wanke rubutun da lita 7 na ruwan rijiya ko Zamzam. Yi amfani da ruwan wajen wanke fuska da jiki kowace safe har kwana 7, kuma ka yayafa a kusurwoyin gidan domin korar shaidanu.`,
  ...
  },
  {
    ...
    element: 'earth',
    secretFr: 'Grand Secret de la Bastion Occulte & Bouclier de Force Telurique. Dans les traités anciens, Kararin est associé au Nom Divin "Ilah Kull Shai" (Le Dieu de toute chose) et possède la puissance d\'une muraille d\'acier invisible. Il ancrera la fréquence vibratoire de l\'opérateur dans la stabilité inébranlable de la terre, rendant son aura totalement imperméable aux attaques psychiques, aux mauvais yeux d'envie destructrice, à la sorcellerie enfouie (Sihr Maqbur) et aux complots feutrés.
...
Wannan suna yana da ikon mayar da asirin makiyayi zuwa kansa da sauri. Yana cika mutum da kwarjini na kariya wanda ke sa makiya tsoron cutar da shi. Karanta shi da lissafinsa (430) yana cire fargaba da tsoro a zuciya, yana ba mutum karfin gwiwa a lokacin matsi.',
    recipeFr: 'Protocole Canonique de Fortification Aural & Protection des Biens :
...
A fannin ilimi da basira, Tatlihin yana bude kwakwalwa wajen harda da fahimtar ilimin asiri mai zurfi. Yana kawo fahimta ta gaggawa, yana cire daushin mantuwa, kuma yana goge duhun tunani domin gane gaskiyar mutane.',
    recipeFr: 'Protocole de Grand Apaisement & Illumination de l\'Esprit :
...
5. Consommation : Faites tremper le document dans l\'eau. Buvez-en un verre à jeun chaque matin pendant 7 jours consécutifs tout en récitant le nom 266 fois. La vitalité revient promptement.',
...
Yana sa mutum ya kasance mai kwarjini a idon kowa wanda ba za a iya raina shi ba. Idan an sami aiki ko neman takarda da ya ki fitowa, Mazjalin yana kawar da kowane cikas a cikin sauri. Yana daukaka mutum kuma yana tsare shi daga wulakanci.',
    recipeFr: 'Protocole de Charisme, Élévation & Réussite aux Enttiens :
...
Lokacin da kofofi suka rufe kuma aka matsawa mutum da zalunci, karanta Barhashin yana kawo agaji na gaggawa daga Allah. Yana 'yanta mutum daga cikas na kudi ko na rayuwa da makiya suka kulla.',
    recipeFr: 'Protocole de Delivrance & Victoire Éclatante :
...
2. Encensement : Brûlez de l\'Oliban.
...
1. Recite 583 times at the conclusion of spiritual retreats.',
...
content += JSON.stringify(namesData, null, 2);

// Append Grand Recipes & Invocations
content += `;\n\n// Read existing rest of file if needed or export GRAND RECIPES & INVOCATIONS\n`;

console.log("Names JS generated. Total length:", content.length);
